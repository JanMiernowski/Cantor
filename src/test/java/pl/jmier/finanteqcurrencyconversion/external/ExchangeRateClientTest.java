...
class ExchangeRateClientTest {
    ...
    @Test
    void shouldReturnValuesForFriday18thOfJuneWhenCurrencyIsCorrectAndDateRequestIs18th() throws JsonProcessingException {
        //given
    ...
    @Test
    void shouldReturnValuesForFriday18thOfJuneWhenCurrencyIsCorrectAndDateRequestIsSunday20th() throws JsonProcessingException {
        //given
    ...
    void shouldThrowExceptionWhenCurrencyIsIncorrect() throws JsonProcessingException {
        ...
        LocalDate localDate = LocalDate.of(2021, 6,20);
        //when
        RuntimeException exception = assertThrows(RuntimeException.class, () -> exchangeRateClient.findCurrencyRate("xxx", localDate));
        //then
